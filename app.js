...
var $author$project$Boggle$initialModel = function () {
	var seed = $elm$random$Random$initialSeed(0);
...
var $author$project$Boggle$main = $elm$browser$Browser$element(
	{
		init: $author$project$Boggle$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Boggle$update,
		view: $author$project$Boggle$view
	});
_Platform_export({'Boggle':{'init':$author$project$Boggle$main(
